...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '3932039f0ac244e8a5e28430c49a7bf1',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '文章宇内千年事，身世江湖万里舟',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '逆梭星', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🔝🌟', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'nisuoxing@protonmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_AO3: process.env.NEXT_PUBLIC_CONTACT_AO3 || 'https://archiveofourown.org/users/Etoile_Sakasa', // 你的微博个人主页
  ...
  POST_WAITING_TIME_FOR_404: process.env.NEXT_PUBLIC_POST_WAITING_TIME_FOR_404 || '16', // 文章加载超时时间，单位秒；超时后跳转到404页面
